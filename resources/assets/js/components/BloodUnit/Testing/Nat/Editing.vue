                  ...
                  <table class="table table-bordered table-condensed">
                      ...
                      <tbody>
                          <tr v-for="(donation,i) in donations" :key="donation.donation_id">
                              ...
                              <td>
                                  <select class="form-control input-sm" v-model="donation.nat">
...
export default {
  ...
  methods : {
      ...
      submitForm(verifier){
          ...
          this.$http.post(this,"testing/savenat",{
              donations,user_id,facility_cd,verifier
          })
          .then(({data}) => {
              this.$store.state.msg = {
                  content : 'N.A.T. Results has been saved successfully',
                  type : 'success'
              };
              this.$emit("cancel");
          });
  ...
  computed : {
      valid(){
          return _.filter(this.donations,d=>!d.nat).length == 0
      }
  }
}
</script>
