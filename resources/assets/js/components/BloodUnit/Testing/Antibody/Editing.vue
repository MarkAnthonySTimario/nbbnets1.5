                  ...
                  <table class="table table-bordered table-condensed">
                      ...
                      <tbody>
                          <tr v-for="(donation,i) in donations" :key="donation.donation_id">
                              ...
                              <td>
                                  <select class="form-control input-sm" v-model="donation.antibody">
...
export default {
  ...
  methods : {
      ...
      submitForm(verifier){
          ...
          this.$http.post(this,"testing/saveantibody",{
              donations,user_id,facility_cd,verifier
          })
          .then(({data}) => {
              this.$store.state.msg = {
                  content : 'Donor Antibody Screening Results has been saved successfully',
                  type : 'success'
              };
              this.$emit("cancel");
          });
  ...
  computed : {
      valid(){
          return _.filter(this.donations,d=>!d.antibody).length == 0
      }
  }
}
</script>
